...
bgp_opts = [
    cfg.StrOpt('interconnect_switch_name',
               default='bgp-ls-interconnect',
               help=_('Name of the interconnect switch for BGP topology.')),
    ...
    cfg.StrOpt('bgp_mac_base',
               default='fa:00:3e:00:00:00',
               help=_('Base MAC address for BGP routers.')),
]
...
def get_interconnect_switch_name():
    return cfg.CONF.bgp.interconnect_switch_name
